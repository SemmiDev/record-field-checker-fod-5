<x-app-layout>
    <div class="flex justify-between">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Data Teams</h1>
        ...
        @forelse ($teams as $name)
            <tr
                ...
                <td class="px-6 py-4 text-right">
                    <a href="{{ route('teams.edit', ['id' => $name->id]) }}"
                    ...
                    <form action="{{ route('teams.destroy', ['id' => $name->id]) }}" method="POST"
                          class="inline-block">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
